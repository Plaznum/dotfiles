...
{
#  fileSystems."/run/media/pandy/kagesuper" =
#    { device = "//192.168.1.96/kagesuper";
#      fsType = "cifs";
#      options = [ "rw" "uid=1000" "username=pandy" "password=s200231404" "x-systemd.automount" "noauto" "x-systemd.idle-timeout=60" "x-systemd.device-timeout=5s" "x-systemd.mount-timeout=5s" ];
#    };
#
#  fileSystems."/run/media/pandy/kagebin" =
#    { device = "//192.168.1.96/kagebin";
#      fsType = "cifs";
#      options = [ "rw" "uid=1000" "username=pandy" "password=s200231404" "x-systemd.automount" "noauto" "x-systemd.idle-timeout=60" "x-systemd.device-timeout=5s" "x-systemd.mount-timeout=5s" ];
#    };
  ...
  fileSystems."/run/media/pandy/dv1" = { 
    device = "//192.168.1.97/rcrews";
    fsType = "cifs";
    options = [ "rw" "uid=1000" "username=rcrews" "password=s200231404" "x-systemd.automount" "noauto" "x-systemd.idle-timeout=60" "x-systemd.device-timeout=5s" "x-systemd.mount-timeout=5s" ];
  };
